...
function LecturerContestsContent() {
  ...
  return (
    <div className="space-y-6">
        <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold font-headline">Contests Management</h1>
        </div>
...
export default function LecturerContests() {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <LecturerContestsContent />
    </Suspense>
  );
}
